...
db_endpoint = open("/home/ec2-user/My-Projects/devops/202-Terraform-Phonebook-Application-deployed-on-AWS/dbserver.endpoint", 'r', encoding='UTF-8') 
...
app.config['MYSQL_DATABASE_PASSWORD'] = 'Murat123'
